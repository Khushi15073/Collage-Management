...
router.get("/", auth_middleware_1.authMiddleware, roleController.getAllRole.bind(roleController));
router.get("/:id", auth_middleware_1.authMiddleware, (req, res) => roleController.getRoleById(req, res));
